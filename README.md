In this project, learn to implement Model-View-Controller (MVC) architecture using PHP. The MVC concept separates an application into three main components:
